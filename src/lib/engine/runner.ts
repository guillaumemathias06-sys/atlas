    ...
    try {
      ...
      const observation = await prisma.priceObservation.create({
        data: {
          ...
          returnLayoverMinutes: best.returnLayoverMinutes,
          returnSelfTransfer: best.returnSelfTransfer,
          returnDepartTime: best.returnDepartTime,
          returnArriveTime: best.returnArriveTime,
      ...
      const flight = computeFlightQualityScore({
        ...
        returnLeg: {
          stops: best.returnStops,
          departTime: best.returnDepartTime,
          arriveTime: best.returnArriveTime,
          selfTransfer: best.returnSelfTransfer,
          layoverMinutes: best.returnLayoverMinutes,
        },
        totalDurationMinutes: best.totalDurationMinutes,
